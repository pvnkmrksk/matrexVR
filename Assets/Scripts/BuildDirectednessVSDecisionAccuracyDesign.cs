...
public class BuildDirectednessVSDecisionAccuracyDesign
{
    [MenuItem("Tools/Generate Directedness VS Decision Accuracy SequenceDesign.json")]
    private static void Build()
    {
        ...
        var steps = new object[]
        {
            new
            {
                name = "Decision_singleBlack_60cm_0deg",
                trigger = barTrigger,
                closedLoopOrientation = true,
                closedLoopPosition = true,
            ...
            new
            {
                name = "Decision_twoBlack_60cm_40deg_noflip",
                trigger = barTrigger,
                closedLoopOrientation = true,
                closedLoopPosition = true,
                randomInitialRotation = false,
            ...
            new
            {
                name = "Decision_twoBlack_60cm_40deg_flip",
                trigger = barTrigger,
                closedLoopOrientation = true,
                closedLoopPosition = true,
                randomInitialRotation = false,
            ...
            new
            {
                name = "Decision_blackGray04_60cm_40deg_noflip",
                trigger = barTrigger,
                closedLoopOrientation = true,
                closedLoopPosition = true,
                randomInitialRotation = false,
            ...
            new
            {
                name = "Decision_Gray04black_60cm_40deg_flip",
                trigger = barTrigger,
                closedLoopOrientation = true,
                closedLoopPosition = true,
                randomInitialRotation = false,
        ...
        string path = Path.Combine(
            ...
            "sequenceDesign_directednessVSDecisionAccuracy.json"
        );
